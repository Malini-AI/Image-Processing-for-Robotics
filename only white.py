...
img = []
c = 0
for i in glob.glob('C:/Users/malin/OneDrive/Desktop/Robotics/ADV_ROBOTICS/png/Carpet/Type1/SQUARE/300/I-300-5-CROP/*.png'):
    n = cv2.imread(i)
    img.append(n)
    c = c+1
...
for m in range(c+1):
    ...
    cv2.imwrite("C:/Users/malin/filterW5/W" + str(m) + ".jpg", res)
